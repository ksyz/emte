...
%global urllib3_unbundled_version 1.10.2
...
%changelog
* Fri Sep 28 2018 Michal Ingeli <mi@v3.sk> - 2.7.0-9
- Set urllib3_unbundled_version to version available in 
  EPEL: 1.10.2 from 1.10.4
